...
const truncate = (body) => (body.length <= BODY_LIMIT ? body : `${body.slice(0, BODY_LIMIT - 1)}…`)
/**
...
export const runNotifier = (events, hooks) => {
  ...
  const pathFor = (channelId, threadId) => {
