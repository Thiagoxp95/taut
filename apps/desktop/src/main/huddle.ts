...
let huddleUrl: string | undefined

const alive = (): BrowserWindow | null =>
  huddleWindow !== null && !huddleWindow.isDestroyed() ? huddleWindow : null

const focus = (window: BrowserWindow): void => {
 ...
 */
export const openHuddle = (instanceUrl: string, path: string): void => {
